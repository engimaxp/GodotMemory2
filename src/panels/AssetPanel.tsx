    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 520 }}>
        <div className="modal-header">
          <span className="modal-title">{isNew ? "Add Asset" : "Edit Asset"}</span>
          <button className="modal-close" onClick={onClose}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></svg>
          </button>
        </div>
        <div className="modal-body">
          <div className="form-group"><label className="form-label">Name</label><input className="form-input" value={name} onChange={e => setName(e.target.value)} placeholder="Asset name" /></div>
          <div className="form-group"><label className="form-label">Directory</label><input className="form-input" value={dir} onChange={e => setDir(e.target.value)} placeholder="Directory path" /></div>
          ...
          <div className="form-group"><label className="form-label">Copyright</label><input className="form-input" value={copyRight} onChange={e => setCopyRight(e.target.value)} placeholder="Copyright info" /></div>
  ...
  return (
    <div className="item-row">
      ...
      <div className="item-info">
        ...
        <div className="item-sub">{e.link || e.directory || "No path"}</div>
      </div>
    ...
    <div className="panel-container">
      <div className="panel-header" style={{ flexDirection: "column", alignItems: "stretch", gap: 6 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button className="btn btn-primary btn-small" onClick={() => { setEditAsset(null); setShowEdit(true); }}>+ Add</button>
        </div>
        {/* Tag filter bar */}
