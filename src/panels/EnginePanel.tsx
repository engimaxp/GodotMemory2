    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 520 }}>
        <div className="modal-header">
          <span className="modal-title">{t(isNew ? "engine.add" : "engine.edit")}</span>
        ...
        <div className="modal-body">
          ...
          <div className="form-row">
            <label className="form-checkbox"><input type="checkbox" checked={hasConsole} onChange={e => setHasConsole(e.target.checked)} /> {t("engine.has_console")}</label>
  ...
  return (
    <div className="item-row">
      ...
      <div className="item-info">
        <div className="item-name">{e.name || t("engine.unnamed")}</div>
          ...
          <div className="flex flex-wrap gap-1">
            ...
            <div ref={tagSearchRef} style={{ position: "relative", display: "inline-flex" }}>
              <input className="tag-input" value={tagSearchText}
                ...
                placeholder={t("tag.search_placeholder")} style={{ width: 120, fontSize: 11, padding: "2px 6px" }} />
